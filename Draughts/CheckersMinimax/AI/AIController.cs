...
namespace CheckersMinimax.AI
{
    public static class AIController
    {
        ...
        // Return true or false depending on if the AI is currently working
        // returns true if the AI is still thinking
        ...
        // returns = Best move for the current players
        ...
        /// returns= Minimax value for this board state
